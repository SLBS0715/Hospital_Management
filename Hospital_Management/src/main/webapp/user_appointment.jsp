...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
 ...
 .backImg{
 background: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url("img/home14.jpg");
 height: 20vh;
 width: 100%;
 ...
 <p class="text-center fs-2 text-white"></p>
  ...
  <option value="female">Female</option>
    ...
    <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Appointment Date</label><input required type="date" class="form-control" name="appoint_date">
    </div>
    <div class="col-md-6">
...
<div class="col-md-6">
    <label for="inputPassword4" class="form-label">Doctor</label><select required class="form-control" name="doct">
